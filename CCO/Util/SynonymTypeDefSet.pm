# $Id: SynonymTypeDefSet.pm 1585 2007-10-12 15:23:38Z erant $
#
...
#
package CCO::Util::SynonymTypeDefSet;

=head1 NAME

CCO::Util::SynonymTypeDefSet - A Set implementation of Synonym Types
...
my $n1 = CCO::Core::SynonymTypeDef->new();

my $n2 = CCO::Core::SynonymTypeDef->new();

my $n3 = CCO::Core::SynonymTypeDef->new();
...
A set (CCO::Util::Set) of synonym type definitions (CCO::Core::SynonymTypeDef).
...
=head2 add
  ...
  Args     - the element (CCO::Core::SynonymTypeDef) to be added
...
=head2 remove
  ...
  Args     - the element (CCO::Core::SynonymTypeDef) to be removed
...
=head2 contains
  ...
  Args     - the element (CCO::Core::SynonymTypeDef) to be checked
...
=head2 equals
  ...
  Args     - the set (CCO::Util::SynonymTypeDefSet) to compare with
