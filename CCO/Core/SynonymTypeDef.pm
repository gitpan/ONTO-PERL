# $Id: SynonymTypeDef.pm 291 2006-06-01 16:21:45Z erant $
#
...
#
package CCO::Core::SynonymTypeDef;
...
sub equals {
	...
	if ($target) {
		...
		$result = $result && ($self->{SCOPE} eq $target->{SCOPE}) if (defined $self->{SCOPE} && defined $target->{SCOPE}); # TODO case: scope1 undefined and scope 2 defined!
	}
	return $result;
}
...
=head1 NAME
    ...
    CCO::Core::SynonymTypeDef  - A synonym type definition. It should contain a synonym 
