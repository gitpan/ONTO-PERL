...
# put (new id, new name)
#
ok($my_map->put('CCO:B0000005', 'Q84JF1_ARATH'));
ok($my_map->contains_key('CCO:B0000005'));
...
#
ok($my_map->put('CCO:B0000005', 'Q84JF2_ARATH'));
...
# removing
#
$my_map->remove_by_key('CCO:B0000005');
ok(!$my_map->contains_key('CCO:B0000005'));
ok(!$my_map->contains_value('Q84JF2_ARATH'));
ok($my_map->size() == 8);
