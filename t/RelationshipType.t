...
# synonym as string
ok(($r2->synonym_as_string())[0] eq "\"part_of\" [CCO:ls, CCO:vm]"   || ($r2->synonym_as_string())[0] eq "\"part_of\" [CCO:vm, CCO:ls]");
$r2->synonym_as_string("part_of", "[CCO:vm2, CCO:ls2]", "EXACT");
ok(($r2->synonym_as_string())[0] eq "\"part_of\" [CCO:ls, CCO:vm]"   || ($r2->synonym_as_string())[0] eq "\"part_of\" [CCO:vm, CCO:ls]");
ok(($r2->synonym_as_string())[1] eq "\"part_of\" [CCO:ls2, CCO:vm2]" || ($r2->synonym_as_string())[1] eq "\"part_of\" [CCO:vm2, CCO:ls2]");
