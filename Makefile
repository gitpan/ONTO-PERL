...
PM_TO_BLIB = CCO/Util/DbxrefSet.pm \
	...
	CCO/Util/CCO_ID_Set.pm \
	$(INST_LIB)/CCO/Util/CCO_ID_Set.pm \
	CCO/Core/Synonym.pm \
	$(INST_LIB)/CCO/Core/Synonym.pm \
	CCO/Core/Def.pm \
	$(INST_LIB)/CCO/Core/Def.pm \
	CCO/Util/CCO_ID_Term_Map.pm \
	$(INST_LIB)/CCO/Util/CCO_ID_Term_Map.pm \
	CCO/Core/Term.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  ...
	  CCO/Util/CCO_ID_Term_Map.pm $(INST_MAN3DIR)/CCO::Util::CCO_ID_Term_Map.$(MAN3EXT) \
	  ...
	  CCO/Util/CCO_ID.pm $(INST_MAN3DIR)/CCO::Util::CCO_ID.$(MAN3EXT) \
...
metafile :
	...
	$(NOECHO) $(ECHO) 'version:      0.27' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  ...
	  CCO/Util/CCO_ID_Term_Map.pm $(INST_LIB)/CCO/Util/CCO_ID_Term_Map.pm \
	  ...
	  CCO/Util/CCO_ID.pm $(INST_LIB)/CCO/Util/CCO_ID.pm \
